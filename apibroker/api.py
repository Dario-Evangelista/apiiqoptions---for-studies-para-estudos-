...
from apibroker.http.login import Login
from apibroker.http.loginv2 import Loginv2
from apibroker.http.logout import Logout
from apibroker.http.login2fa import Login2FA
from apibroker.http.send_sms import SMS_Sender
from apibroker.http.verify import Verify
from apibroker.http.getprofile import Getprofile
from apibroker.http.auth import Auth
from apibroker.http.token import Token
from apibroker.http.appinit import Appinit
from apibroker.http.billing import Billing
from apibroker.http.buyback import Buyback
from apibroker.http.changebalance import Changebalance
from apibroker.http.events import Events
from apibroker.ws.client import WebsocketClient
from apibroker.ws.received import all_game
from apibroker.ws.chanels.get_balances import *

from apibroker.ws.chanels.ssid import Ssid
from apibroker.ws.chanels.subscribe import *
from apibroker.ws.chanels.unsubscribe import *
from apibroker.ws.chanels.setactives import SetActives
from apibroker.ws.chanels.candles import GetCandles
from apibroker.ws.chanels.buyv2 import Buyv2
from apibroker.ws.chanels.buyv3 import *
from apibroker.ws.chanels.user import *
from apibroker.ws.chanels.api_game_betinfo import Game_betinfo
from apibroker.ws.chanels.instruments import Get_instruments
from apibroker.ws.chanels.get_financial_information import GetFinancialInformation
from apibroker.ws.chanels.strike_list import Strike_list
from apibroker.ws.chanels.leaderboard import Leader_Board

from apibroker.ws.chanels.traders_mood import Traders_mood_subscribe
from apibroker.ws.chanels.traders_mood import Traders_mood_unsubscribe
from apibroker.ws.chanels.technical_indicators import Technical_indicators
from apibroker.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from apibroker.ws.chanels.get_order import Get_order
from apibroker.ws.chanels.get_deferred_orders import GetDeferredOrders
from apibroker.ws.chanels.get_positions import *

from apibroker.ws.chanels.get_available_leverages import Get_available_leverages
from apibroker.ws.chanels.cancel_order import Cancel_order
from apibroker.ws.chanels.close_position import Close_position
from apibroker.ws.chanels.get_overnight_fee import Get_overnight_fee
from apibroker.ws.chanels.heartbeat import Heartbeat


from apibroker.ws.chanels.digital_option import *
from apibroker.ws.chanels.api_game_getoptions import *
from apibroker.ws.chanels.sell_option import Sell_Option
from apibroker.ws.chanels.sell_digital_option import Sell_Digital_Option
from apibroker.ws.chanels.change_tpsl import Change_Tpsl
from apibroker.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from apibroker.ws.objects.timesync import TimeSync
from apibroker.ws.objects.profile import Profile
from apibroker.ws.objects.candles import Candles
from apibroker.ws.objects.listinfodata import ListInfoData
from apibroker.ws.objects.betinfo import Game_betinfo_data
...
class IQOptionAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    socket_option_open_digital = None
    socket_option_closed = {}
    _socket_option_closed = {}
    timesync = TimeSync()
    profile = Profile()
    candles = Candles()
    ...
    option_news_initialization = None
    # for digital
    ...
    def __init__(self, host, username, password, proxies=None, conta=None):
        """
        ...
        if host == 'trade.avalonbroker.com/':
            self.wss_url = "wss://ws.trade.avalonbroker.com/echo/websocket".format(host=host)
        elif host == 'trade.exnova.com/':
            self.wss_url = "wss://ws.trade.exnova.com/echo/websocket".format(host=host)
        ...
        self.__active_account_type = conta
        self.host = host
    ...
    def login_2fa(self):
        ...
        """
        return Login2FA(self, self.host)
    ...
    #     """
    #     return Profile(self)
    def reset_training_balance(self, id):
        logger = logging.getLogger(__name__)
        data = json.dumps({
            "name": "sendMessage",
            "request_id": "702", 
...
# -------------------------------------------------------
    ...
    def start_websocket(self):
        ...
        all_game.ws_conect(self.__active_account_type)
    ...
    def connect(self):
        ...
        # the ssid is None need get ssid
            ...
            response = self.get_ssid(self.host)
            try:
                global_value.SSID = response.cookies["ssid"]
            except:
                self.close()
